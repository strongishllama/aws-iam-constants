...
export enum AmplifyUIBuilder {
  ...
  EXCHANGE_CODE_FOR_TOKEN = "amplifyuibuilder:ExchangeCodeForToken",
  ...
  LIST_TAGS_FOR_RESOURCE = "amplifyuibuilder:ListTagsForResource",
  LIST_THEMES = "amplifyuibuilder:ListThemes",
  REFRESH_TOKEN = "amplifyuibuilder:RefreshToken",
  TAG_RESOURCE = "amplifyuibuilder:TagResource",
  UNTAG_RESOURCE = "amplifyuibuilder:UntagResource",
...
export enum ElasticDisasterRecovery {
  ...
  CREATE_SESSION_FOR_DRS = "drs:CreateSessionForDrs",
