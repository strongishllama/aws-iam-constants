...
export enum Comprehend {
  ...
  CREATE_DATASET = "comprehend:CreateDataset",
  ...
  CREATE_FLYWHEEL = "comprehend:CreateFlywheel",
  ...
  DELETE_FLYWHEEL = "comprehend:DeleteFlywheel",
  DELETE_RESOURCE_POLICY = "comprehend:DeleteResourcePolicy",
  DESCRIBE_DATASET = "comprehend:DescribeDataset",
  ...
  DESCRIBE_FLYWHEEL = "comprehend:DescribeFlywheel",
  DESCRIBE_FLYWHEEL_ITERATION = "comprehend:DescribeFlywheelIteration",
  ...
  LIST_DATASETS = "comprehend:ListDatasets",
  ...
  LIST_FLYWHEEL_ITERATION_HISTORY = "comprehend:ListFlywheelIterationHistory",
  LIST_FLYWHEELS = "comprehend:ListFlywheels",
  ...
  START_FLYWHEEL_ITERATION = "comprehend:StartFlywheelIteration",
  ...
  UPDATE_FLYWHEEL = "comprehend:UpdateFlywheel",
}
...
export enum Glue {
  ...
  CANCEL_M_L_TASK_RUN = "glue:CancelMLTaskRun",
  ...
  CREATE_M_L_TRANSFORM = "glue:CreateMLTransform",
  ...
  DELETE_M_L_TRANSFORM = "glue:DeleteMLTransform",
  ...
  GET_M_L_TASK_RUN = "glue:GetMLTaskRun",
  GET_M_L_TASK_RUNS = "glue:GetMLTaskRuns",
  GET_M_L_TRANSFORM = "glue:GetMLTransform",
  GET_M_L_TRANSFORMS = "glue:GetMLTransforms",
  ...
  LIST_M_L_TRANSFORMS = "glue:ListMLTransforms",
  ...
  START_M_L_EVALUATION_TASK_RUN = "glue:StartMLEvaluationTaskRun",
  START_M_L_LABELING_SET_GENERATION_TASK_RUN = "glue:StartMLLabelingSetGenerationTaskRun",
  ...
  UPDATE_JOB_FROM_SOURCE_CONTROL = "glue:UpdateJobFromSourceControl",
  UPDATE_M_L_TRANSFORM = "glue:UpdateMLTransform",
  UPDATE_PARTITION = "glue:UpdatePartition",
  UPDATE_REGISTRY = "glue:UpdateRegistry",
  UPDATE_SCHEMA = "glue:UpdateSchema",
  UPDATE_SOURCE_CONTROL_FROM_JOB = "glue:UpdateSourceControlFromJob",
...
export enum IAMIdentityCentersuccessortoSingleSignOn {
  ...
  DESCRIBE_DIRECTORIES = "sso:DescribeDirectories",
  ...
  DESCRIBE_TRUSTS = "sso:DescribeTrusts",
  ...
  GET_S_S_O_STATUS = "sso:GetSSOStatus",
  ...
  UPDATE_S_S_O_CONFIGURATION = "sso:UpdateSSOConfiguration",
...
export enum IoT {
  ...
  CREATE_O_T_A_UPDATE = "iot:CreateOTAUpdate",
  ...
  DELETE_C_A_CERTIFICATE = "iot:DeleteCACertificate",
  ...
  DELETE_O_T_A_UPDATE = "iot:DeleteOTAUpdate",
  ...
  DELETE_V2_LOGGING_LEVEL = "iot:DeleteV2LoggingLevel",
  ...
  DESCRIBE_C_A_CERTIFICATE = "iot:DescribeCACertificate",
  ...
  GET_O_T_A_UPDATE = "iot:GetOTAUpdate",
  ...
  GET_V2_LOGGING_OPTIONS = "iot:GetV2LoggingOptions",
  ...
  LIST_C_A_CERTIFICATES = "iot:ListCACertificates",
  LIST_CERTIFICATES = "iot:ListCertificates",
  LIST_CERTIFICATES_BY_C_A = "iot:ListCertificatesByCA",
  ...
  LIST_O_T_A_UPDATES = "iot:ListOTAUpdates",
  ...
  LIST_RELATED_RESOURCES_FOR_AUDIT_FINDING = "iot:ListRelatedResourcesForAuditFinding",
  ...
  LIST_V2_LOGGING_LEVELS = "iot:ListV2LoggingLevels",
  ...
  RECEIVE = "iot:Receive",
  REGISTER_C_A_CERTIFICATE = "iot:RegisterCACertificate",
  REGISTER_CERTIFICATE = "iot:RegisterCertificate",
  REGISTER_CERTIFICATE_WITHOUT_C_A = "iot:RegisterCertificateWithoutCA",
  ...
  SET_V2_LOGGING_LEVEL = "iot:SetV2LoggingLevel",
  SET_V2_LOGGING_OPTIONS = "iot:SetV2LoggingOptions",
  ...
  UPDATE_C_A_CERTIFICATE = "iot:UpdateCACertificate",
...
export enum Lambda {
  ...
  GET_RUNTIME_MANAGEMENT_CONFIG = "lambda:GetRuntimeManagementConfig",
  ...
  PUT_RUNTIME_MANAGEMENT_CONFIG = "lambda:PutRuntimeManagementConfig",
...
export enum MachineLearning {
  ...
  CREATE_DATA_SOURCE_FROM_S3 = "machinelearning:CreateDataSourceFromS3",
  CREATE_EVALUATION = "machinelearning:CreateEvaluation",
  CREATE_M_L_MODEL = "machinelearning:CreateMLModel",
  ...
  DELETE_M_L_MODEL = "machinelearning:DeleteMLModel",
  ...
  DESCRIBE_M_L_MODELS = "machinelearning:DescribeMLModels",
  ...
  GET_M_L_MODEL = "machinelearning:GetMLModel",
...
export enum GuardDuty {
  ...
  CREATE_I_P_SET = "guardduty:CreateIPSet",
  ...
  DELETE_I_P_SET = "guardduty:DeleteIPSet",
  ...
  GET_I_P_SET = "guardduty:GetIPSet",
  ...
  LIST_I_P_SETS = "guardduty:ListIPSets",
  ...
  UPDATE_I_P_SET = "guardduty:UpdateIPSet",
...
export enum FinSpaceAPI {
  GET_PROGRAMMATIC_ACCESS_CREDENTIALS = "finspace-api:GetProgrammaticAccessCredentials",
}
...
export enum CodeGuruSecurity {
  BATCH_GET_FINDINGS = "codeguru-security:BatchGetFindings",
  CREATE_SCAN = "codeguru-security:CreateScan",
  CREATE_UPLOAD_URL = "codeguru-security:CreateUploadUrl",
  DELETE_SCANS_BY_CATEGORY = "codeguru-security:DeleteScansByCategory",
  GET_SCAN = "codeguru-security:GetScan",
  LIST_FINDINGS = "codeguru-security:ListFindings",
  LIST_SCANS = "codeguru-security:ListScans",
  UPDATE_ACCOUNT_CONFIGURATION = "codeguru-security:UpdateAccountConfiguration",
}
...
export enum SupplyChain {
  ASSIGN_ADMIN_PERMISSIONS_TO_USER = "scn:AssignAdminPermissionsToUser",
  CREATE_INSTANCE = "scn:CreateInstance",
  CREATE_S_S_O_APPLICATION = "scn:CreateSSOApplication",
  DELETE_INSTANCE = "scn:DeleteInstance",
  DELETE_S_S_O_APPLICATION = "scn:DeleteSSOApplication",
  DESCRIBE_INSTANCE = "scn:DescribeInstance",
  LIST_ADMIN_USERS = "scn:ListAdminUsers",
  LIST_INSTANCES = "scn:ListInstances",
  REMOVE_ADMIN_PERMISSIONS_FOR_USER = "scn:RemoveAdminPermissionsForUser",
  UPDATE_INSTANCE = "scn:UpdateInstance",
}
...
export enum S3 {
  ...
  GET_BUCKET_C_O_R_S = "s3:GetBucketCORS",
  ...
  PUT_BUCKET_C_O_R_S = "s3:PutBucketCORS",
...
export enum SageMaker {
  ...
  CREATE_AUTO_M_L_JOB = "sagemaker:CreateAutoMLJob",
  ...
  DESCRIBE_AUTO_M_L_JOB = "sagemaker:DescribeAutoMLJob",
  ...
  GET_DEPLOYMENTS = "sagemaker:GetDeployments",
  ...
  LIST_AUTO_M_L_JOBS = "sagemaker:ListAutoMLJobs",
  LIST_CANDIDATES_FOR_AUTO_M_L_JOB = "sagemaker:ListCandidatesForAutoMLJob",
  ...
  STOP_AUTO_M_L_JOB = "sagemaker:StopAutoMLJob",
...
export enum LakeFormation {
  ADD_L_F_TAGS_TO_RESOURCE = "lakeformation:AddLFTagsToResource",
  ...
  CREATE_L_F_TAG = "lakeformation:CreateLFTag",
  DELETE_DATA_CELLS_FILTER = "lakeformation:DeleteDataCellsFilter",
  DELETE_L_F_TAG = "lakeformation:DeleteLFTag",
  ...
  LIST_L_F_TAGS = "lakeformation:ListLFTags",
  ...
  REMOVE_L_F_TAGS_FROM_RESOURCE = "lakeformation:RemoveLFTagsFromResource",
  REVOKE_PERMISSIONS = "lakeformation:RevokePermissions",
  SEARCH_DATABASES_BY_L_F_TAGS = "lakeformation:SearchDatabasesByLFTags",
  SEARCH_TABLES_BY_L_F_TAGS = "lakeformation:SearchTablesByLFTags",
  START_QUERY_PLANNING = "lakeformation:StartQueryPlanning",
  START_TRANSACTION = "lakeformation:StartTransaction",
  UPDATE_L_F_TAG = "lakeformation:UpdateLFTag",
...
export enum ElementalMediaTailor {
  CONFIGURE_LOGS_FOR_CHANNEL = "mediatailor:ConfigureLogsForChannel",
  ...
  UPDATE_PROGRAM = "mediatailor:UpdateProgram",
...
export enum Route53 {
  ...
  CREATE_V_P_C_ASSOCIATION_AUTHORIZATION = "route53:CreateVPCAssociationAuthorization",
  ...
  DELETE_V_P_C_ASSOCIATION_AUTHORIZATION = "route53:DeleteVPCAssociationAuthorization",
  DISABLE_HOSTED_ZONE_D_N_S_S_E_C = "route53:DisableHostedZoneDNSSEC",
  DISASSOCIATE_V_P_C_FROM_HOSTED_ZONE = "route53:DisassociateVPCFromHostedZone",
  ENABLE_HOSTED_ZONE_D_N_S_S_E_C = "route53:EnableHostedZoneDNSSEC",
  GET_ACCOUNT_LIMIT = "route53:GetAccountLimit",
  GET_CHANGE = "route53:GetChange",
  GET_CHECKER_IP_RANGES = "route53:GetCheckerIpRanges",
  GET_D_N_S_S_E_C = "route53:GetDNSSEC",
  ...
  LIST_HOSTED_ZONES_BY_V_P_C = "route53:ListHostedZonesByVPC",
  ...
  LIST_V_P_C_ASSOCIATION_AUTHORIZATIONS = "route53:ListVPCAssociationAuthorizations",
  TEST_D_N_S_ANSWER = "route53:TestDNSAnswer",
...
export enum ResilienceHubService {
  ...
  CREATE_APP_VERSION_APP_COMPONENT = "resiliencehub:CreateAppVersionAppComponent",
  CREATE_APP_VERSION_RESOURCE = "resiliencehub:CreateAppVersionResource",
  ...
  DELETE_APP_INPUT_SOURCE = "resiliencehub:DeleteAppInputSource",
  DELETE_APP_VERSION_APP_COMPONENT = "resiliencehub:DeleteAppVersionAppComponent",
  DELETE_APP_VERSION_RESOURCE = "resiliencehub:DeleteAppVersionResource",
  ...
  DESCRIBE_APP_VERSION = "resiliencehub:DescribeAppVersion",
  DESCRIBE_APP_VERSION_APP_COMPONENT = "resiliencehub:DescribeAppVersionAppComponent",
  DESCRIBE_APP_VERSION_RESOURCE = "resiliencehub:DescribeAppVersionResource",
  ...
  LIST_APP_INPUT_SOURCES = "resiliencehub:ListAppInputSources",
  LIST_APP_VERSION_APP_COMPONENTS = "resiliencehub:ListAppVersionAppComponents",
  ...
  UPDATE_APP_VERSION = "resiliencehub:UpdateAppVersion",
  UPDATE_APP_VERSION_APP_COMPONENT = "resiliencehub:UpdateAppVersionAppComponent",
  UPDATE_APP_VERSION_RESOURCE = "resiliencehub:UpdateAppVersionResource",
...
export enum Athena {
  ...
  LIST_APPLICATION_D_P_U_SIZES = "athena:ListApplicationDPUSizes",
...
export enum Pinpoint {
  ...
  GET_JOURNEY_RUN_EXECUTION_ACTIVITY_METRICS = "mobiletargeting:GetJourneyRunExecutionActivityMetrics",
  GET_JOURNEY_RUN_EXECUTION_METRICS = "mobiletargeting:GetJourneyRunExecutionMetrics",
  GET_JOURNEY_RUNS = "mobiletargeting:GetJourneyRuns",
  ...
  SEND_O_T_P_MESSAGE = "mobiletargeting:SendOTPMessage",
  ...
  VERIFY_O_T_P_MESSAGE = "mobiletargeting:VerifyOTPMessage",
}
...
export enum FreeRTOS {
  ...
  GET_SOFTWARE_U_R_L = "freertos:GetSoftwareURL",
  GET_SOFTWARE_U_R_L_FOR_CONFIGURATION = "freertos:GetSoftwareURLForConfiguration",
  LIST_FREE_R_T_O_S_VERSIONS = "freertos:ListFreeRTOSVersions",
...
export enum IdentityandAccessManagement {
  ...
  CREATE_OPEN_I_D_CONNECT_PROVIDER = "iam:CreateOpenIDConnectProvider",
  CREATE_POLICY = "iam:CreatePolicy",
  CREATE_POLICY_VERSION = "iam:CreatePolicyVersion",
  CREATE_ROLE = "iam:CreateRole",
  CREATE_S_A_M_L_PROVIDER = "iam:CreateSAMLProvider",
  ...
  CREATE_VIRTUAL_M_F_A_DEVICE = "iam:CreateVirtualMFADevice",
  DEACTIVATE_M_F_A_DEVICE = "iam:DeactivateMFADevice",
  ...
  DELETE_OPEN_I_D_CONNECT_PROVIDER = "iam:DeleteOpenIDConnectProvider",
  ...
  DELETE_S_A_M_L_PROVIDER = "iam:DeleteSAMLProvider",
  DELETE_S_S_H_PUBLIC_KEY = "iam:DeleteSSHPublicKey",
  ...
  GET_OPEN_I_D_CONNECT_PROVIDER = "iam:GetOpenIDConnectProvider",
  ...
  GET_S_A_M_L_PROVIDER = "iam:GetSAMLProvider",
  GET_S_S_H_PUBLIC_KEY = "iam:GetSSHPublicKey",
  ...
  LIST_M_F_A_DEVICE_TAGS = "iam:ListMFADeviceTags",
  LIST_M_F_A_DEVICES = "iam:ListMFADevices",
  LIST_OPEN_I_D_CONNECT_PROVIDER_TAGS = "iam:ListOpenIDConnectProviderTags",
  LIST_OPEN_I_D_CONNECT_PROVIDERS = "iam:ListOpenIDConnectProviders",
  ...
  LIST_VIRTUAL_M_F_A_DEVICES = "iam:ListVirtualMFADevices",
  ...
  REMOVE_CLIENT_I_D_FROM_OPEN_I_D_CONNECT_PROVIDER = "iam:RemoveClientIDFromOpenIDConnectProvider",
  ...
  TAG_M_F_A_DEVICE = "iam:TagMFADevice",
  TAG_OPEN_I_D_CONNECT_PROVIDER = "iam:TagOpenIDConnectProvider",
  TAG_POLICY = "iam:TagPolicy",
  TAG_ROLE = "iam:TagRole",
  TAG_S_A_M_L_PROVIDER = "iam:TagSAMLProvider",
  TAG_SERVER_CERTIFICATE = "iam:TagServerCertificate",
  TAG_USER = "iam:TagUser",
  UNTAG_INSTANCE_PROFILE = "iam:UntagInstanceProfile",
  UNTAG_M_F_A_DEVICE = "iam:UntagMFADevice",
  UNTAG_OPEN_I_D_CONNECT_PROVIDER = "iam:UntagOpenIDConnectProvider",
  UNTAG_POLICY = "iam:UntagPolicy",
  UNTAG_ROLE = "iam:UntagRole",
  UNTAG_S_A_M_L_PROVIDER = "iam:UntagSAMLProvider",
  ...
  UPDATE_S_A_M_L_PROVIDER = "iam:UpdateSAMLProvider",
  UPDATE_S_S_H_PUBLIC_KEY = "iam:UpdateSSHPublicKey",
...
export enum Connect {
  ...
  LIST_PHONE_NUMBERS_V2 = "connect:ListPhoneNumbersV2",
...
export enum AmplifyAdmin {
  ...
  DELETE_BACKEND_A_P_I = "amplifybackend:DeleteBackendAPI",
  ...
  GENERATE_BACKEND_A_P_I_MODELS = "amplifybackend:GenerateBackendAPIModels",
  GET_BACKEND = "amplifybackend:GetBackend",
  GET_BACKEND_A_P_I = "amplifybackend:GetBackendAPI",
  GET_BACKEND_A_P_I_MODELS = "amplifybackend:GetBackendAPIModels",
...
export enum IAMIdentityCentersuccessortoSingleSignOndirectory {
  ...
  GET_A_W_S_S_P_CONFIGURATION_FOR_DIRECTORY = "sso-directory:GetAWSSPConfigurationForDirectory",
...
export enum RDS {
  ADD_ROLE_TO_D_B_CLUSTER = "rds:AddRoleToDBCluster",
  ADD_ROLE_TO_D_B_INSTANCE = "rds:AddRoleToDBInstance",
  ...
  AUTHORIZE_D_B_SECURITY_GROUP_INGRESS = "rds:AuthorizeDBSecurityGroupIngress",
  BACKTRACK_D_B_CLUSTER = "rds:BacktrackDBCluster",
  CANCEL_EXPORT_TASK = "rds:CancelExportTask",
  COPY_D_B_CLUSTER_PARAMETER_GROUP = "rds:CopyDBClusterParameterGroup",
  COPY_D_B_CLUSTER_SNAPSHOT = "rds:CopyDBClusterSnapshot",
  COPY_D_B_PARAMETER_GROUP = "rds:CopyDBParameterGroup",
  COPY_D_B_SNAPSHOT = "rds:CopyDBSnapshot",
  COPY_OPTION_GROUP = "rds:CopyOptionGroup",
  CREATE_BLUE_GREEN_DEPLOYMENT = "rds:CreateBlueGreenDeployment",
  CREATE_CUSTOM_D_B_ENGINE_VERSION = "rds:CreateCustomDBEngineVersion",
  CREATE_D_B_CLUSTER = "rds:CreateDBCluster",
  CREATE_D_B_CLUSTER_ENDPOINT = "rds:CreateDBClusterEndpoint",
  CREATE_D_B_CLUSTER_PARAMETER_GROUP = "rds:CreateDBClusterParameterGroup",
  CREATE_D_B_CLUSTER_SNAPSHOT = "rds:CreateDBClusterSnapshot",
  CREATE_D_B_INSTANCE = "rds:CreateDBInstance",
  CREATE_D_B_INSTANCE_READ_REPLICA = "rds:CreateDBInstanceReadReplica",
  CREATE_D_B_PARAMETER_GROUP = "rds:CreateDBParameterGroup",
  CREATE_D_B_PROXY = "rds:CreateDBProxy",
  CREATE_D_B_PROXY_ENDPOINT = "rds:CreateDBProxyEndpoint",
  CREATE_D_B_SECURITY_GROUP = "rds:CreateDBSecurityGroup",
  CREATE_D_B_SNAPSHOT = "rds:CreateDBSnapshot",
  CREATE_D_B_SUBNET_GROUP = "rds:CreateDBSubnetGroup",
  ...
  DELETE_CUSTOM_D_B_ENGINE_VERSION = "rds:DeleteCustomDBEngineVersion",
  DELETE_D_B_CLUSTER = "rds:DeleteDBCluster",
  DELETE_D_B_CLUSTER_ENDPOINT = "rds:DeleteDBClusterEndpoint",
  DELETE_D_B_CLUSTER_PARAMETER_GROUP = "rds:DeleteDBClusterParameterGroup",
  DELETE_D_B_CLUSTER_SNAPSHOT = "rds:DeleteDBClusterSnapshot",
  DELETE_D_B_INSTANCE = "rds:DeleteDBInstance",
  DELETE_D_B_INSTANCE_AUTOMATED_BACKUP = "rds:DeleteDBInstanceAutomatedBackup",
  DELETE_D_B_PARAMETER_GROUP = "rds:DeleteDBParameterGroup",
  DELETE_D_B_PROXY = "rds:DeleteDBProxy",
  DELETE_D_B_PROXY_ENDPOINT = "rds:DeleteDBProxyEndpoint",
  DELETE_D_B_SECURITY_GROUP = "rds:DeleteDBSecurityGroup",
  DELETE_D_B_SNAPSHOT = "rds:DeleteDBSnapshot",
  DELETE_D_B_SUBNET_GROUP = "rds:DeleteDBSubnetGroup",
  ...
  DEREGISTER_D_B_PROXY_TARGETS = "rds:DeregisterDBProxyTargets",
  ...
  DESCRIBE_D_B_CLUSTER_BACKTRACKS = "rds:DescribeDBClusterBacktracks",
  DESCRIBE_D_B_CLUSTER_ENDPOINTS = "rds:DescribeDBClusterEndpoints",
  DESCRIBE_D_B_CLUSTER_PARAMETER_GROUPS = "rds:DescribeDBClusterParameterGroups",
  DESCRIBE_D_B_CLUSTER_PARAMETERS = "rds:DescribeDBClusterParameters",
  DESCRIBE_D_B_CLUSTER_SNAPSHOT_ATTRIBUTES = "rds:DescribeDBClusterSnapshotAttributes",
  DESCRIBE_D_B_CLUSTER_SNAPSHOTS = "rds:DescribeDBClusterSnapshots",
  DESCRIBE_D_B_CLUSTERS = "rds:DescribeDBClusters",
  DESCRIBE_D_B_ENGINE_VERSIONS = "rds:DescribeDBEngineVersions",
  DESCRIBE_D_B_INSTANCE_AUTOMATED_BACKUPS = "rds:DescribeDBInstanceAutomatedBackups",
  DESCRIBE_D_B_INSTANCES = "rds:DescribeDBInstances",
  DESCRIBE_D_B_LOG_FILES = "rds:DescribeDBLogFiles",
  DESCRIBE_D_B_PARAMETER_GROUPS = "rds:DescribeDBParameterGroups",
  DESCRIBE_D_B_PARAMETERS = "rds:DescribeDBParameters",
  DESCRIBE_D_B_PROXIES = "rds:DescribeDBProxies",
  DESCRIBE_D_B_PROXY_ENDPOINTS = "rds:DescribeDBProxyEndpoints",
  DESCRIBE_D_B_PROXY_TARGET_GROUPS = "rds:DescribeDBProxyTargetGroups",
  DESCRIBE_D_B_PROXY_TARGETS = "rds:DescribeDBProxyTargets",
  DESCRIBE_D_B_SECURITY_GROUPS = "rds:DescribeDBSecurityGroups",
  DESCRIBE_D_B_SNAPSHOT_ATTRIBUTES = "rds:DescribeDBSnapshotAttributes",
  DESCRIBE_D_B_SNAPSHOTS = "rds:DescribeDBSnapshots",
  DESCRIBE_D_B_SUBNET_GROUPS = "rds:DescribeDBSubnetGroups",
  ...
  DESCRIBE_ORDERABLE_D_B_INSTANCE_OPTIONS = "rds:DescribeOrderableDBInstanceOptions",
  ...
  DESCRIBE_RESERVED_D_B_INSTANCES = "rds:DescribeReservedDBInstances",
  DESCRIBE_RESERVED_D_B_INSTANCES_OFFERINGS = "rds:DescribeReservedDBInstancesOfferings",
  DESCRIBE_SOURCE_REGIONS = "rds:DescribeSourceRegions",
  DESCRIBE_VALID_D_B_INSTANCE_MODIFICATIONS = "rds:DescribeValidDBInstanceModifications",
  DOWNLOAD_COMPLETE_D_B_LOG_FILE = "rds:DownloadCompleteDBLogFile",
  DOWNLOAD_D_B_LOG_FILE_PORTION = "rds:DownloadDBLogFilePortion",
  FAILOVER_D_B_CLUSTER = "rds:FailoverDBCluster",
  ...
  MODIFY_CURRENT_D_B_CLUSTER_CAPACITY = "rds:ModifyCurrentDBClusterCapacity",
  MODIFY_CUSTOM_D_B_ENGINE_VERSION = "rds:ModifyCustomDBEngineVersion",
  MODIFY_D_B_CLUSTER = "rds:ModifyDBCluster",
  MODIFY_D_B_CLUSTER_ENDPOINT = "rds:ModifyDBClusterEndpoint",
  MODIFY_D_B_CLUSTER_PARAMETER_GROUP = "rds:ModifyDBClusterParameterGroup",
  MODIFY_D_B_CLUSTER_SNAPSHOT_ATTRIBUTE = "rds:ModifyDBClusterSnapshotAttribute",
  MODIFY_D_B_INSTANCE = "rds:ModifyDBInstance",
  MODIFY_D_B_PARAMETER_GROUP = "rds:ModifyDBParameterGroup",
  MODIFY_D_B_PROXY = "rds:ModifyDBProxy",
  MODIFY_D_B_PROXY_ENDPOINT = "rds:ModifyDBProxyEndpoint",
  MODIFY_D_B_PROXY_TARGET_GROUP = "rds:ModifyDBProxyTargetGroup",
  MODIFY_D_B_SNAPSHOT = "rds:ModifyDBSnapshot",
  MODIFY_D_B_SNAPSHOT_ATTRIBUTE = "rds:ModifyDBSnapshotAttribute",
  MODIFY_D_B_SUBNET_GROUP = "rds:ModifyDBSubnetGroup",
  ...
  PROMOTE_READ_REPLICA_D_B_CLUSTER = "rds:PromoteReadReplicaDBCluster",
  PURCHASE_RESERVED_D_B_INSTANCES_OFFERING = "rds:PurchaseReservedDBInstancesOffering",
  REBOOT_D_B_CLUSTER = "rds:RebootDBCluster",
  REBOOT_D_B_INSTANCE = "rds:RebootDBInstance",
  REGISTER_D_B_PROXY_TARGETS = "rds:RegisterDBProxyTargets",
  REMOVE_FROM_GLOBAL_CLUSTER = "rds:RemoveFromGlobalCluster",
  REMOVE_ROLE_FROM_D_B_CLUSTER = "rds:RemoveRoleFromDBCluster",
  REMOVE_ROLE_FROM_D_B_INSTANCE = "rds:RemoveRoleFromDBInstance",
  ...
  RESET_D_B_CLUSTER_PARAMETER_GROUP = "rds:ResetDBClusterParameterGroup",
  RESET_D_B_PARAMETER_GROUP = "rds:ResetDBParameterGroup",
  RESTORE_D_B_CLUSTER_FROM_S3 = "rds:RestoreDBClusterFromS3",
  RESTORE_D_B_CLUSTER_FROM_SNAPSHOT = "rds:RestoreDBClusterFromSnapshot",
  RESTORE_D_B_CLUSTER_TO_POINT_IN_TIME = "rds:RestoreDBClusterToPointInTime",
  RESTORE_D_B_INSTANCE_FROM_D_B_SNAPSHOT = "rds:RestoreDBInstanceFromDBSnapshot",
  RESTORE_D_B_INSTANCE_FROM_S3 = "rds:RestoreDBInstanceFromS3",
  RESTORE_D_B_INSTANCE_TO_POINT_IN_TIME = "rds:RestoreDBInstanceToPointInTime",
  REVOKE_D_B_SECURITY_GROUP_INGRESS = "rds:RevokeDBSecurityGroupIngress",
  START_ACTIVITY_STREAM = "rds:StartActivityStream",
  START_D_B_CLUSTER = "rds:StartDBCluster",
  START_D_B_INSTANCE = "rds:StartDBInstance",
  START_D_B_INSTANCE_AUTOMATED_BACKUPS_REPLICATION = "rds:StartDBInstanceAutomatedBackupsReplication",
  START_EXPORT_TASK = "rds:StartExportTask",
  STOP_ACTIVITY_STREAM = "rds:StopActivityStream",
  STOP_D_B_CLUSTER = "rds:StopDBCluster",
  STOP_D_B_INSTANCE = "rds:StopDBInstance",
...
export enum AppSync {
  ...
  SET_WEB_A_C_L = "appsync:SetWebACL",
...
export enum CloudFront {
  ...
  LIST_DISTRIBUTIONS_BY_WEB_A_C_L_ID = "cloudfront:ListDistributionsByWebACLId",
...
export enum ElasticKubernetesService {
  ...
  DESCRIBE_ADDON_CONFIGURATION = "eks:DescribeAddonConfiguration",
...
export enum DirectoryService {
  ...
  CREATE_MICROSOFT_A_D = "ds:CreateMicrosoftAD",
  ...
  DESCRIBE_L_D_A_P_S_SETTINGS = "ds:DescribeLDAPSSettings",
...
export enum IoTSiteWise {
  ...
  LIST_ASSET_MODEL_PROPERTIES = "iotsitewise:ListAssetModelProperties",
  LIST_ASSET_MODELS = "iotsitewise:ListAssetModels",
  LIST_ASSET_PROPERTIES = "iotsitewise:ListAssetProperties",
...
export enum FraudDetector {
  ...
  CREATE_LIST = "frauddetector:CreateList",
  ...
  DELETE_LIST = "frauddetector:DeleteList",
  ...
  GET_K_M_S_ENCRYPTION_KEY = "frauddetector:GetKMSEncryptionKey",
  GET_LABELS = "frauddetector:GetLabels",
  GET_LIST_ELEMENTS = "frauddetector:GetListElements",
  GET_LISTS_METADATA = "frauddetector:GetListsMetadata",
  ...
  PUT_K_M_S_ENCRYPTION_KEY = "frauddetector:PutKMSEncryptionKey",
  ...
  UPDATE_LIST = "frauddetector:UpdateList",
...
export enum Chime {
  ...
  CREATE_C_D_R_BUCKET = "chime:CreateCDRBucket",
  ...
  DELETE_C_D_R_BUCKET = "chime:DeleteCDRBucket",
  ...
  GET_C_D_R_BUCKET = "chime:GetCDRBucket",
  ...
  GET_SIP_MEDIA_APPLICATION_ALEXA_SKILL_CONFIGURATION = "chime:GetSipMediaApplicationAlexaSkillConfiguration",
  ...
  LIST_AVAILABLE_VOICE_CONNECTOR_REGIONS = "chime:ListAvailableVoiceConnectorRegions",
  LIST_BOTS = "chime:ListBots",
  LIST_C_D_R_BUCKET = "chime:ListCDRBucket",
  ...
  PUT_SIP_MEDIA_APPLICATION_ALEXA_SKILL_CONFIGURATION = "chime:PutSipMediaApplicationAlexaSkillConfiguration",
  ...
  RESET_PERSONAL_P_I_N = "chime:ResetPersonalPIN",
  ...
  UPDATE_C_D_R_SETTINGS = "chime:UpdateCDRSettings",
  ...
  VALIDATE_E911_ADDRESS = "chime:ValidateE911Address",
}
...
export enum MechanicalTurk {
  ...
  CREATE_ADDITIONAL_ASSIGNMENTS_FOR_H_I_T = "mechanicalturk:CreateAdditionalAssignmentsForHIT",
  CREATE_H_I_T = "mechanicalturk:CreateHIT",
  CREATE_H_I_T_TYPE = "mechanicalturk:CreateHITType",
  CREATE_H_I_T_WITH_H_I_T_TYPE = "mechanicalturk:CreateHITWithHITType",
  CREATE_QUALIFICATION_TYPE = "mechanicalturk:CreateQualificationType",
  CREATE_WORKER_BLOCK = "mechanicalturk:CreateWorkerBlock",
  DELETE_H_I_T = "mechanicalturk:DeleteHIT",
  ...
  GET_FILE_UPLOAD_U_R_L = "mechanicalturk:GetFileUploadURL",
  GET_H_I_T = "mechanicalturk:GetHIT",
  GET_QUALIFICATION_SCORE = "mechanicalturk:GetQualificationScore",
  GET_QUALIFICATION_TYPE = "mechanicalturk:GetQualificationType",
  LIST_ASSIGNMENTS_FOR_H_I_T = "mechanicalturk:ListAssignmentsForHIT",
  LIST_BONUS_PAYMENTS = "mechanicalturk:ListBonusPayments",
  LIST_H_I_TS = "mechanicalturk:ListHITs",
  LIST_H_I_TS_FOR_QUALIFICATION_TYPE = "mechanicalturk:ListHITsForQualificationType",
  ...
  LIST_REVIEW_POLICY_RESULTS_FOR_H_I_T = "mechanicalturk:ListReviewPolicyResultsForHIT",
  LIST_REVIEWABLE_H_I_TS = "mechanicalturk:ListReviewableHITs",
  ...
  UPDATE_EXPIRATION_FOR_H_I_T = "mechanicalturk:UpdateExpirationForHIT",
  UPDATE_H_I_T_REVIEW_STATUS = "mechanicalturk:UpdateHITReviewStatus",
  UPDATE_H_I_T_TYPE_OF_H_I_T = "mechanicalturk:UpdateHITTypeOfHIT",
...
export enum StorageGateway {
  ...
  CREATE_CACHEDI_S_C_S_I_VOLUME = "storagegateway:CreateCachediSCSIVolume",
  CREATE_N_F_S_FILE_SHARE = "storagegateway:CreateNFSFileShare",
  CREATE_S_M_B_FILE_SHARE = "storagegateway:CreateSMBFileShare",
  ...
  CREATE_STOREDI_S_C_S_I_VOLUME = "storagegateway:CreateStorediSCSIVolume",
  ...
  DESCRIBE_CACHEDI_S_C_S_I_VOLUMES = "storagegateway:DescribeCachediSCSIVolumes",
  ...
  DESCRIBE_N_F_S_FILE_SHARES = "storagegateway:DescribeNFSFileShares",
  DESCRIBE_S_M_B_FILE_SHARES = "storagegateway:DescribeSMBFileShares",
  DESCRIBE_S_M_B_SETTINGS = "storagegateway:DescribeSMBSettings",
  DESCRIBE_SNAPSHOT_SCHEDULE = "storagegateway:DescribeSnapshotSchedule",
  DESCRIBE_STOREDI_S_C_S_I_VOLUMES = "storagegateway:DescribeStorediSCSIVolumes",
  ...
  DESCRIBE_V_T_L_DEVICES = "storagegateway:DescribeVTLDevices",
  ...
  SET_S_M_B_GUEST_PASSWORD = "storagegateway:SetSMBGuestPassword",
  ...
  UPDATE_N_F_S_FILE_SHARE = "storagegateway:UpdateNFSFileShare",
  UPDATE_S_M_B_FILE_SHARE = "storagegateway:UpdateSMBFileShare",
  UPDATE_S_M_B_FILE_SHARE_VISIBILITY = "storagegateway:UpdateSMBFileShareVisibility",
  UPDATE_S_M_B_LOCAL_GROUPS = "storagegateway:UpdateSMBLocalGroups",
  UPDATE_S_M_B_SECURITY_STRATEGY = "storagegateway:UpdateSMBSecurityStrategy",
...
export enum ElasticMapReduce {
  ...
  CREATE_PERSISTENT_APP_U_I = "elasticmapreduce:CreatePersistentAppUI",
  ...
  DESCRIBE_PERSISTENT_APP_U_I = "elasticmapreduce:DescribePersistentAppUI",
...
export enum DynamoDB {
  ...
  DESCRIBE_ENDPOINTS = "dynamodb:DescribeEndpoints",
  ...
  PARTI_Q_L_DELETE = "dynamodb:PartiQLDelete",
  PARTI_Q_L_INSERT = "dynamodb:PartiQLInsert",
  PARTI_Q_L_SELECT = "dynamodb:PartiQLSelect",
  PARTI_Q_L_UPDATE = "dynamodb:PartiQLUpdate",
  ...
  UPDATE_GLOBAL_TABLE_VERSION = "dynamodb:UpdateGlobalTableVersion",
...
export enum OpenSearchService {
  ...
  AUTHORIZE_VPC_ENDPOINT_ACCESS = "es:AuthorizeVpcEndpointAccess",
  ...
  CREATE_VPC_ENDPOINT = "es:CreateVpcEndpoint",
  ...
  DELETE_VPC_ENDPOINT = "es:DeleteVpcEndpoint",
  ...
  DESCRIBE_VPC_ENDPOINTS = "es:DescribeVpcEndpoints",
  DISSOCIATE_PACKAGE = "es:DissociatePackage",
  E_S_CROSS_CLUSTER_GET = "es:ESCrossClusterGet",
  E_S_HTTP_DELETE = "es:ESHttpDelete",
  E_S_HTTP_GET = "es:ESHttpGet",
  E_S_HTTP_HEAD = "es:ESHttpHead",
  E_S_HTTP_PATCH = "es:ESHttpPatch",
  E_S_HTTP_POST = "es:ESHttpPost",
  E_S_HTTP_PUT = "es:ESHttpPut",
  ...
  LIST_VPC_ENDPOINT_ACCESS = "es:ListVpcEndpointAccess",
  LIST_VPC_ENDPOINTS = "es:ListVpcEndpoints",
  LIST_VPC_ENDPOINTS_FOR_DOMAIN = "es:ListVpcEndpointsForDomain",
  ...
  REVOKE_VPC_ENDPOINT_ACCESS = "es:RevokeVpcEndpointAccess",
  ...
  UPDATE_VPC_ENDPOINT = "es:UpdateVpcEndpoint",
...
export enum AlexaforBusiness {
  ...
  REGISTER_A_V_S_DEVICE = "a4b:RegisterAVSDevice",
...
export enum Redshift {
  ...
  GET_CLUSTER_CREDENTIALS_WITH_I_A_M = "redshift:GetClusterCredentialsWithIAM",
...
export enum MarketplaceManagementPortal {
  ...
  IEW_SETTINGS = "aws-marketplace-management:viewSettings",
...
export enum ComprehendMedical {
  ...
  DESCRIBE_S_N_O_M_E_D_C_T_INFERENCE_JOB = "comprehendmedical:DescribeSNOMEDCTInferenceJob",
  DETECT_ENTITIES_V2 = "comprehendmedical:DetectEntitiesV2",
  DETECT_P_H_I = "comprehendmedical:DetectPHI",
  INFER_I_C_D10_C_M = "comprehendmedical:InferICD10CM",
  INFER_RX_NORM = "comprehendmedical:InferRxNorm",
  INFER_S_N_O_M_E_D_C_T = "comprehendmedical:InferSNOMEDCT",
  LIST_ENTITIES_DETECTION_V2_JOBS = "comprehendmedical:ListEntitiesDetectionV2Jobs",
  LIST_I_C_D10_C_M_INFERENCE_JOBS = "comprehendmedical:ListICD10CMInferenceJobs",
  LIST_P_H_I_DETECTION_JOBS = "comprehendmedical:ListPHIDetectionJobs",
  LIST_RX_NORM_INFERENCE_JOBS = "comprehendmedical:ListRxNormInferenceJobs",
  LIST_S_N_O_M_E_D_C_T_INFERENCE_JOBS = "comprehendmedical:ListSNOMEDCTInferenceJobs",
  START_ENTITIES_DETECTION_V2_JOB = "comprehendmedical:StartEntitiesDetectionV2Job",
  START_I_C_D10_C_M_INFERENCE_JOB = "comprehendmedical:StartICD10CMInferenceJob",
  START_P_H_I_DETECTION_JOB = "comprehendmedical:StartPHIDetectionJob",
  START_RX_NORM_INFERENCE_JOB = "comprehendmedical:StartRxNormInferenceJob",
  START_S_N_O_M_E_D_C_T_INFERENCE_JOB = "comprehendmedical:StartSNOMEDCTInferenceJob",
  STOP_ENTITIES_DETECTION_V2_JOB = "comprehendmedical:StopEntitiesDetectionV2Job",
  STOP_I_C_D10_C_M_INFERENCE_JOB = "comprehendmedical:StopICD10CMInferenceJob",
  STOP_P_H_I_DETECTION_JOB = "comprehendmedical:StopPHIDetectionJob",
  STOP_RX_NORM_INFERENCE_JOB = "comprehendmedical:StopRxNormInferenceJob",
  STOP_S_N_O_M_E_D_C_T_INFERENCE_JOB = "comprehendmedical:StopSNOMEDCTInferenceJob",
}
...
export enum ManagedBlockchain {
  CREATE_ACCESSOR = "managedblockchain:CreateAccessor",
  ...
  DELETE_ACCESSOR = "managedblockchain:DeleteAccessor",
  DELETE_MEMBER = "managedblockchain:DeleteMember",
  DELETE_NODE = "managedblockchain:DeleteNode",
  G_E_T = "managedblockchain:GET",
  GET_ACCESSOR = "managedblockchain:GetAccessor",
  ...
  LIST_ACCESSORS = "managedblockchain:ListAccessors",
  ...
  P_O_S_T = "managedblockchain:POST",
...
export enum WAF {
  ...
  CREATE_I_P_SET = "waf:CreateIPSet",
  ...
  CREATE_WEB_A_C_L = "waf:CreateWebACL",
  CREATE_WEB_A_C_L_MIGRATION_STACK = "waf:CreateWebACLMigrationStack",
  ...
  DELETE_I_P_SET = "waf:DeleteIPSet",
  ...
  DELETE_WEB_A_C_L = "waf:DeleteWebACL",
  ...
  LIST_WEB_A_C_LS = "waf:ListWebACLs",
  ...
  UPDATE_I_P_SET = "waf:UpdateIPSet",
  ...
  UPDATE_WEB_A_C_L = "waf:UpdateWebACL",
...
export enum AppStream20 {
  ...
  CREATE_IMAGE_BUILDER_STREAMING_U_R_L = "appstream:CreateImageBuilderStreamingURL",
  CREATE_STACK = "appstream:CreateStack",
  CREATE_STREAMING_U_R_L = "appstream:CreateStreamingURL",
...
export enum QuickSight {
  ...
  CREATE_I_A_M_POLICY_ASSIGNMENT = "quicksight:CreateIAMPolicyAssignment",
  ...
  DELETE_I_A_M_POLICY_ASSIGNMENT = "quicksight:DeleteIAMPolicyAssignment",
  ...
  DELETE_V_P_C_CONNECTION = "quicksight:DeleteVPCConnection",
  ...
  DESCRIBE_I_A_M_POLICY_ASSIGNMENT = "quicksight:DescribeIAMPolicyAssignment",
  ...
  LIST_I_A_M_POLICY_ASSIGNMENTS = "quicksight:ListIAMPolicyAssignments",
  LIST_I_A_M_POLICY_ASSIGNMENTS_FOR_USER = "quicksight:ListIAMPolicyAssignmentsForUser",
  ...
  UPDATE_I_A_M_POLICY_ASSIGNMENT = "quicksight:UpdateIAMPolicyAssignment",
...
export enum WAFV2 {
  ...
  DELETE_WEB_A_C_L = "wafv2:DeleteWebACL",
  ...
  DISASSOCIATE_WEB_A_C_L = "wafv2:DisassociateWebACL",
  GENERATE_MOBILE_SDK_RELEASE_URL = "wafv2:GenerateMobileSdkReleaseUrl",
  GET_I_P_SET = "wafv2:GetIPSet",
  ...
  GET_WEB_A_C_L = "wafv2:GetWebACL",
  GET_WEB_A_C_L_FOR_RESOURCE = "wafv2:GetWebACLForResource",
  ...
  LIST_I_P_SETS = "wafv2:ListIPSets",
  ...
  LIST_RESOURCES_FOR_WEB_A_C_L = "wafv2:ListResourcesForWebACL",
  LIST_RULE_GROUPS = "wafv2:ListRuleGroups",
  LIST_TAGS_FOR_RESOURCE = "wafv2:ListTagsForResource",
  LIST_WEB_A_C_LS = "wafv2:ListWebACLs",
  ...
  UPDATE_I_P_SET = "wafv2:UpdateIPSet",
...
export enum ConnectCases {
  ...
  DELETE_DOMAIN = "cases:DeleteDomain",
...
export enum Lightsail {
  ...
  GET_CONTAINER_A_P_I_METADATA = "lightsail:GetContainerAPIMetadata",
...
export enum CloudSearch {
  ...
  OCUMENT = "cloudsearch:document",
  EARCH = "cloudsearch:search",
...
export enum IoTFleetWise {
  ...
  BATCH_CREATE_VEHICLE = "iotfleetwise:BatchCreateVehicle",
  BATCH_UPDATE_VEHICLE = "iotfleetwise:BatchUpdateVehicle",
...
export enum PriceList {
  ...
  GET_PRICE_LIST_FILE_URL = "pricing:GetPriceListFileUrl",
  GET_PRODUCTS = "pricing:GetProducts",
  LIST_PRICE_LISTS = "pricing:ListPriceLists",
}
...
export enum Backup {
  ...
  GET_BACKUP_PLAN_FROM_J_S_O_N = "backup:GetBackupPlanFromJSON",
...
export enum RHELKnowledgebasePortal {
  GET_RHEL_U_R_L = "rhelkb:GetRhelURL",
}
...
export enum DatabaseMigrationService {
  ...
  CREATE_FLEET_ADVISOR_COLLECTOR = "dms:CreateFleetAdvisorCollector",
  ...
  DELETE_FLEET_ADVISOR_COLLECTOR = "dms:DeleteFleetAdvisorCollector",
  DELETE_FLEET_ADVISOR_DATABASES = "dms:DeleteFleetAdvisorDatabases",
  ...
  DESCRIBE_FLEET_ADVISOR_COLLECTORS = "dms:DescribeFleetAdvisorCollectors",
  DESCRIBE_FLEET_ADVISOR_DATABASES = "dms:DescribeFleetAdvisorDatabases",
  DESCRIBE_FLEET_ADVISOR_LSA_ANALYSIS = "dms:DescribeFleetAdvisorLsaAnalysis",
  DESCRIBE_FLEET_ADVISOR_SCHEMA_OBJECT_SUMMARY = "dms:DescribeFleetAdvisorSchemaObjectSummary",
  DESCRIBE_FLEET_ADVISOR_SCHEMAS = "dms:DescribeFleetAdvisorSchemas",
  ...
  MODIFY_FLEET_ADVISOR_COLLECTOR = "dms:ModifyFleetAdvisorCollector",
  MODIFY_FLEET_ADVISOR_COLLECTOR_STATUSES = "dms:ModifyFleetAdvisorCollectorStatuses",
  ...
  RUN_FLEET_ADVISOR_LSA_ANALYSIS = "dms:RunFleetAdvisorLsaAnalysis",
...
export enum IQPermissions {
  ...
  APPROVE_PERMISSION_REQUEST = "iq-permission:ApprovePermissionRequest",
  CREATE_PERMISSION_REQUEST = "iq-permission:CreatePermissionRequest",
  GET_PERMISSION_REQUEST = "iq-permission:GetPermissionRequest",
  LIST_PERMISSION_REQUESTS = "iq-permission:ListPermissionRequests",
  REJECT_PERMISSION_REQUEST = "iq-permission:RejectPermissionRequest",
  REVOKE_PERMISSION_REQUEST = "iq-permission:RevokePermissionRequest",
  WITHDRAW_PERMISSION_REQUEST = "iq-permission:WithdrawPermissionRequest",
}
...
export enum DeviceFarm {
  ...
  CREATE_V_P_C_E_CONFIGURATION = "devicefarm:CreateVPCEConfiguration",
  ...
  DELETE_V_P_C_E_CONFIGURATION = "devicefarm:DeleteVPCEConfiguration",
  ...
  GET_V_P_C_E_CONFIGURATION = "devicefarm:GetVPCEConfiguration",
  ...
  LIST_V_P_C_E_CONFIGURATIONS = "devicefarm:ListVPCEConfigurations",
...
export enum GroundStation {
  ...
  CREATE_EPHEMERIS = "groundstation:CreateEphemeris",
  ...
  LIST_EPHEMERIDES = "groundstation:ListEphemerides",
  ...
  UPDATE_EPHEMERIS = "groundstation:UpdateEphemeris",
...
export enum IQ {
  ACCEPT_CALL = "iq:AcceptCall",
  APPROVE_PAYMENT_REQUEST = "iq:ApprovePaymentRequest",
  APPROVE_PROPOSAL = "iq:ApproveProposal",
  ARCHIVE_CONVERSATION = "iq:ArchiveConversation",
  COMPLETE_PROPOSAL = "iq:CompleteProposal",
  CREATE_CONVERSATION = "iq:CreateConversation",
  CREATE_EXPERT = "iq:CreateExpert",
  CREATE_LISTING = "iq:CreateListing",
  CREATE_MILESTONE_PROPOSAL = "iq:CreateMilestoneProposal",
  CREATE_PAYMENT_REQUEST = "iq:CreatePaymentRequest",
  CREATE_PROJECT = "iq:CreateProject",
  CREATE_REQUEST = "iq:CreateRequest",
  CREATE_SCHEDULED_PROPOSAL = "iq:CreateScheduledProposal",
  CREATE_SELLER = "iq:CreateSeller",
  CREATE_UPFRONT_PROPOSAL = "iq:CreateUpfrontProposal",
  DECLINE_CALL = "iq:DeclineCall",
  DELETE_ATTACHMENT = "iq:DeleteAttachment",
  END_CALL = "iq:EndCall",
  GET_BUYER = "iq:GetBuyer",
  GET_CALL = "iq:GetCall",
  GET_CHAT_INFO = "iq:GetChatInfo",
  GET_CHAT_MESSAGES = "iq:GetChatMessages",
  GET_CHAT_TOKEN = "iq:GetChatToken",
  GET_COMPANY_PROFILE = "iq:GetCompanyProfile",
  GET_CONVERSATION = "iq:GetConversation",
  GET_EXPERT = "iq:GetExpert",
  GET_LISTING = "iq:GetListing",
  GET_MARKETPLACE_SELLER = "iq:GetMarketplaceSeller",
  GET_PAYMENT_REQUEST = "iq:GetPaymentRequest",
  GET_PROPOSAL = "iq:GetProposal",
  GET_REVIEW = "iq:GetReview",
  HIDE_REQUEST = "iq:HideRequest",
  INITIATE_CALL = "iq:InitiateCall",
  LIST_CONVERSATIONS = "iq:ListConversations",
  LIST_LISTINGS = "iq:ListListings",
  LIST_PAYMENT_REQUESTS = "iq:ListPaymentRequests",
  LIST_PROPOSALS = "iq:ListProposals",
  LIST_REQUESTS = "iq:ListRequests",
  LIST_REVIEWS = "iq:ListReviews",
  MARK_CHAT_MESSAGE_READ = "iq:MarkChatMessageRead",
  REJECT_PAYMENT_REQUEST = "iq:RejectPaymentRequest",
  REJECT_PROPOSAL = "iq:RejectProposal",
  SEND_COMPANY_CHAT_MESSAGE = "iq:SendCompanyChatMessage",
  SEND_INDIVIDUAL_CHAT_MESSAGE = "iq:SendIndividualChatMessage",
  UNARCHIVE_CONVERSATION = "iq:UnarchiveConversation",
  UPDATE_COMPANY_PROFILE = "iq:UpdateCompanyProfile",
  UPDATE_CONVERSATION_MEMBERS = "iq:UpdateConversationMembers",
  UPDATE_EXPERT = "iq:UpdateExpert",
  UPDATE_LISTING = "iq:UpdateListing",
  UPDATE_REQUEST = "iq:UpdateRequest",
  UPLOAD_ATTACHMENT = "iq:UploadAttachment",
  WITHDRAW_PAYMENT_REQUEST = "iq:WithdrawPaymentRequest",
  WITHDRAW_PROPOSAL = "iq:WithdrawProposal",
  WRITE_REVIEW = "iq:WriteReview",
}

export enum TelcoNetworkBuilder {
  CANCEL_SOL_NETWORK_OPERATION = "tnb:CancelSolNetworkOperation",
  CREATE_SOL_FUNCTION_PACKAGE = "tnb:CreateSolFunctionPackage",
  CREATE_SOL_NETWORK_INSTANCE = "tnb:CreateSolNetworkInstance",
  CREATE_SOL_NETWORK_PACKAGE = "tnb:CreateSolNetworkPackage",
  DELETE_SOL_FUNCTION_PACKAGE = "tnb:DeleteSolFunctionPackage",
  DELETE_SOL_NETWORK_INSTANCE = "tnb:DeleteSolNetworkInstance",
  DELETE_SOL_NETWORK_PACKAGE = "tnb:DeleteSolNetworkPackage",
  GET_SOL_FUNCTION_INSTANCE = "tnb:GetSolFunctionInstance",
  GET_SOL_FUNCTION_PACKAGE = "tnb:GetSolFunctionPackage",
  GET_SOL_FUNCTION_PACKAGE_CONTENT = "tnb:GetSolFunctionPackageContent",
  GET_SOL_FUNCTION_PACKAGE_DESCRIPTOR = "tnb:GetSolFunctionPackageDescriptor",
  GET_SOL_NETWORK_INSTANCE = "tnb:GetSolNetworkInstance",
  GET_SOL_NETWORK_OPERATION = "tnb:GetSolNetworkOperation",
  GET_SOL_NETWORK_PACKAGE = "tnb:GetSolNetworkPackage",
  GET_SOL_NETWORK_PACKAGE_CONTENT = "tnb:GetSolNetworkPackageContent",
  GET_SOL_NETWORK_PACKAGE_DESCRIPTOR = "tnb:GetSolNetworkPackageDescriptor",
  INSTANTIATE_SOL_NETWORK_INSTANCE = "tnb:InstantiateSolNetworkInstance",
  LIST_SOL_FUNCTION_INSTANCES = "tnb:ListSolFunctionInstances",
  LIST_SOL_FUNCTION_PACKAGES = "tnb:ListSolFunctionPackages",
  LIST_SOL_NETWORK_INSTANCES = "tnb:ListSolNetworkInstances",
  LIST_SOL_NETWORK_OPERATIONS = "tnb:ListSolNetworkOperations",
  LIST_SOL_NETWORK_PACKAGES = "tnb:ListSolNetworkPackages",
  LIST_TAGS_FOR_RESOURCE = "tnb:ListTagsForResource",
  PUT_SOL_FUNCTION_PACKAGE_CONTENT = "tnb:PutSolFunctionPackageContent",
  PUT_SOL_NETWORK_PACKAGE_CONTENT = "tnb:PutSolNetworkPackageContent",
  TAG_RESOURCE = "tnb:TagResource",
  TERMINATE_SOL_NETWORK_INSTANCE = "tnb:TerminateSolNetworkInstance",
  UNTAG_RESOURCE = "tnb:UntagResource",
  UPDATE_SOL_FUNCTION_PACKAGE = "tnb:UpdateSolFunctionPackage",
  UPDATE_SOL_NETWORK_INSTANCE = "tnb:UpdateSolNetworkInstance",
  UPDATE_SOL_NETWORK_PACKAGE = "tnb:UpdateSolNetworkPackage",
  VALIDATE_SOL_FUNCTION_PACKAGE_CONTENT = "tnb:ValidateSolFunctionPackageContent",
  VALIDATE_SOL_NETWORK_PACKAGE_CONTENT = "tnb:ValidateSolNetworkPackageContent",
}
...
export enum SnowDeviceManagement {
  ...
  DESCRIBE_DEVICE_EC2_INSTANCES = "snow-device-management:DescribeDeviceEc2Instances",
...
export enum APIGatewayManagement {
  ...
  SET_WEB_A_C_L = "apigateway:SetWebACL",
...
export enum ManagedStreamingforApacheKafka {
  ...
  CREATE_CLUSTER_V2 = "kafka:CreateClusterV2",
  ...
  DESCRIBE_CLUSTER_V2 = "kafka:DescribeClusterV2",
  ...
  LIST_CLUSTERS_V2 = "kafka:ListClustersV2",
...
export enum EC2AutoScaling {
  ...
  ATTACH_TRAFFIC_SOURCES = "autoscaling:AttachTrafficSources",
  ...
  DESCRIBE_TRAFFIC_SOURCES = "autoscaling:DescribeTrafficSources",
  ...
  DETACH_TRAFFIC_SOURCES = "autoscaling:DetachTrafficSources",
  ...
  ROLLBACK_INSTANCE_REFRESH = "autoscaling:RollbackInstanceRefresh",
...
export enum Snowball {
  ...
  LIST_SERVICE_VERSIONS = "snowball:ListServiceVersions",
...
export enum Shield {
  ...
  DESCRIBE_D_R_T_ACCESS = "shield:DescribeDRTAccess",
  ...
  DISASSOCIATE_D_R_T_LOG_BUCKET = "shield:DisassociateDRTLogBucket",
  DISASSOCIATE_D_R_T_ROLE = "shield:DisassociateDRTRole",
...
export enum FSx {
  ...
  RELEASE_FILE_SYSTEM_NFS_V3_LOCKS = "fsx:ReleaseFileSystemNfsV3Locks",
...
export enum KinesisVideoStreams {
  ...
  GET_D_A_S_H_STREAMING_SESSION_U_R_L = "kinesisvideo:GetDASHStreamingSessionURL",
  GET_DATA_ENDPOINT = "kinesisvideo:GetDataEndpoint",
  GET_H_L_S_STREAMING_SESSION_U_R_L = "kinesisvideo:GetHLSStreamingSessionURL",
...
export enum EC2 {
  ...
  ASSIGN_IPV6_ADDRESSES = "ec2:AssignIpv6Addresses",
  ...
  ASSOCIATE_IPAM_RESOURCE_DISCOVERY = "ec2:AssociateIpamResourceDiscovery",
  ...
  CREATE_IPAM_RESOURCE_DISCOVERY = "ec2:CreateIpamResourceDiscovery",
  ...
  CREATE_PUBLIC_IPV4_POOL = "ec2:CreatePublicIpv4Pool",
  ...
  DELETE_IPAM_RESOURCE_DISCOVERY = "ec2:DeleteIpamResourceDiscovery",
  ...
  DELETE_PUBLIC_IPV4_POOL = "ec2:DeletePublicIpv4Pool",
  ...
  DEPROVISION_PUBLIC_IPV4_POOL_CIDR = "ec2:DeprovisionPublicIpv4PoolCidr",
  ...
  DESCRIBE_IPAM_RESOURCE_DISCOVERIES = "ec2:DescribeIpamResourceDiscoveries",
  DESCRIBE_IPAM_RESOURCE_DISCOVERY_ASSOCIATIONS = "ec2:DescribeIpamResourceDiscoveryAssociations",
  DESCRIBE_IPAM_SCOPES = "ec2:DescribeIpamScopes",
  DESCRIBE_IPAMS = "ec2:DescribeIpams",
  DESCRIBE_IPV6_POOLS = "ec2:DescribeIpv6Pools",
  ...
  DESCRIBE_PUBLIC_IPV4_POOLS = "ec2:DescribePublicIpv4Pools",
  ...
  DISASSOCIATE_IPAM_RESOURCE_DISCOVERY = "ec2:DisassociateIpamResourceDiscovery",
  ...
  ENABLE_VOLUME_I_O = "ec2:EnableVolumeIO",
  ...
  GET_ASSOCIATED_IPV6_POOL_CIDRS = "ec2:GetAssociatedIpv6PoolCidrs",
  ...
  GET_IPAM_DISCOVERED_ACCOUNTS = "ec2:GetIpamDiscoveredAccounts",
  GET_IPAM_DISCOVERED_RESOURCE_CIDRS = "ec2:GetIpamDiscoveredResourceCidrs",
  ...
  MODIFY_IPAM_RESOURCE_DISCOVERY = "ec2:ModifyIpamResourceDiscovery",
  ...
  PAUSE_VOLUME_I_O = "ec2:PauseVolumeIO",
  PROVISION_BYOIP_CIDR = "ec2:ProvisionByoipCidr",
  PROVISION_IPAM_POOL_CIDR = "ec2:ProvisionIpamPoolCidr",
  PROVISION_PUBLIC_IPV4_POOL_CIDR = "ec2:ProvisionPublicIpv4PoolCidr",
  ...
  UNASSIGN_IPV6_ADDRESSES = "ec2:UnassignIpv6Addresses",
...
export enum GameLift {
  ...
  DESCRIBE_E_C2_INSTANCE_LIMITS = "gamelift:DescribeEC2InstanceLimits",
...
export enum Route53RecoveryControls {
  ...
  LIST_ASSOCIATED_ROUTE53_HEALTH_CHECKS = "route53-recovery-control-config:ListAssociatedRoute53HealthChecks",
...
export enum Timestream {
  ...
  CREATE_BATCH_LOAD_TASK = "timestream:CreateBatchLoadTask",
  ...
  DESCRIBE_BATCH_LOAD_TASK = "timestream:DescribeBatchLoadTask",
  ...
  LIST_BATCH_LOAD_TASKS = "timestream:ListBatchLoadTasks",
  ...
  RESUME_BATCH_LOAD_TASK = "timestream:ResumeBatchLoadTask",
...
export enum SNS {
  ...
  CREATE_S_M_S_SANDBOX_PHONE_NUMBER = "sns:CreateSMSSandboxPhoneNumber",
  CREATE_TOPIC = "sns:CreateTopic",
  DELETE_ENDPOINT = "sns:DeleteEndpoint",
  DELETE_PLATFORM_APPLICATION = "sns:DeletePlatformApplication",
  DELETE_S_M_S_SANDBOX_PHONE_NUMBER = "sns:DeleteSMSSandboxPhoneNumber",
  ...
  GET_S_M_S_ATTRIBUTES = "sns:GetSMSAttributes",
  GET_S_M_S_SANDBOX_ACCOUNT_STATUS = "sns:GetSMSSandboxAccountStatus",
  ...
  LIST_S_M_S_SANDBOX_PHONE_NUMBERS = "sns:ListSMSSandboxPhoneNumbers",
  ...
  SET_S_M_S_ATTRIBUTES = "sns:SetSMSAttributes",
  ...
  VERIFY_S_M_S_SANDBOX_PHONE_NUMBER = "sns:VerifySMSSandboxPhoneNumber",
}
...
export enum CognitoUserPools {
  ...
  ADMIN_SET_USER_M_F_A_PREFERENCE = "cognito-idp:AdminSetUserMFAPreference",
  ...
  ASSOCIATE_WEB_A_C_L = "cognito-idp:AssociateWebACL",
  ...
  DISASSOCIATE_WEB_A_C_L = "cognito-idp:DisassociateWebACL",
  FORGET_DEVICE = "cognito-idp:ForgetDevice",
  FORGOT_PASSWORD = "cognito-idp:ForgotPassword",
  GET_C_S_V_HEADER = "cognito-idp:GetCSVHeader",
  ...
  GET_U_I_CUSTOMIZATION = "cognito-idp:GetUICustomization",
  ...
  GET_WEB_A_C_L_FOR_RESOURCE = "cognito-idp:GetWebACLForResource",
  ...
  LIST_RESOURCES_FOR_WEB_A_C_L = "cognito-idp:ListResourcesForWebACL",
  ...
  SET_U_I_CUSTOMIZATION = "cognito-idp:SetUICustomization",
  SET_USER_M_F_A_PREFERENCE = "cognito-idp:SetUserMFAPreference",
...
export enum ElasticBeanstalk {
  ...
  CHECK_D_N_S_AVAILABILITY = "elasticbeanstalk:CheckDNSAvailability",
  ...
  SWAP_ENVIRONMENT_C_N_A_M_ES = "elasticbeanstalk:SwapEnvironmentCNAMEs",
...
export enum ElasticLoadBalancing {
  ...
  CREATE_L_B_COOKIE_STICKINESS_POLICY = "elasticloadbalancing:CreateLBCookieStickinessPolicy",
  ...
  SET_LOAD_BALANCER_LISTENER_S_S_L_CERTIFICATE = "elasticloadbalancing:SetLoadBalancerListenerSSLCertificate",
...
export enum ElasticLoadBalancingV2 {
  ...
  DESCRIBE_S_S_L_POLICIES = "elasticloadbalancing:DescribeSSLPolicies",
  DESCRIBE_TAGS = "elasticloadbalancing:DescribeTags",
...
export enum WAFRegional {
  ...
  CREATE_I_P_SET = "waf-regional:CreateIPSet",
  ...
  CREATE_WEB_A_C_L = "waf-regional:CreateWebACL",
  CREATE_WEB_A_C_L_MIGRATION_STACK = "waf-regional:CreateWebACLMigrationStack",
  ...
  DELETE_I_P_SET = "waf-regional:DeleteIPSet",
  ...
  DELETE_WEB_A_C_L = "waf-regional:DeleteWebACL",
  DELETE_XSS_MATCH_SET = "waf-regional:DeleteXssMatchSet",
  DISASSOCIATE_WEB_A_C_L = "waf-regional:DisassociateWebACL",
  ...
  GET_I_P_SET = "waf-regional:GetIPSet",
  ...
  GET_WEB_A_C_L = "waf-regional:GetWebACL",
  GET_WEB_A_C_L_FOR_RESOURCE = "waf-regional:GetWebACLForResource",
  ...
  LIST_I_P_SETS = "waf-regional:ListIPSets",
  ...
  LIST_RESOURCES_FOR_WEB_A_C_L = "waf-regional:ListResourcesForWebACL",
  ...
  LIST_WEB_A_C_LS = "waf-regional:ListWebACLs",
  ...
  UPDATE_I_P_SET = "waf-regional:UpdateIPSet",
  ...
  UPDATE_WEB_A_C_L = "waf-regional:UpdateWebACL",
...
export enum ElasticContainerService {
  ...
  DELETE_TASK_DEFINITIONS = "ecs:DeleteTaskDefinitions",
  ...
  GET_TASK_PROTECTION = "ecs:GetTaskProtection",
  ...
  UPDATE_TASK_PROTECTION = "ecs:UpdateTaskProtection",
...
export enum ServiceCatalog {
  ...
  DISABLE_A_W_S_ORGANIZATIONS_ACCESS = "servicecatalog:DisableAWSOrganizationsAccess",
  ...
  ENABLE_A_W_S_ORGANIZATIONS_ACCESS = "servicecatalog:EnableAWSOrganizationsAccess",
  ...
  GET_A_W_S_ORGANIZATIONS_ACCESS_STATUS = "servicecatalog:GetAWSOrganizationsAccessStatus",
...
export enum ControlTower {
  ...
  DELETE_LANDING_ZONE = "controltower:DeleteLandingZone",
  ...
  DESCRIBE_LANDING_ZONE_CONFIGURATION = "controltower:DescribeLandingZoneConfiguration",
  ...
  DESCRIBE_REGISTER_ORGANIZATIONAL_UNIT_OPERATION = "controltower:DescribeRegisterOrganizationalUnitOperation",
  ...
  GET_ACCOUNT_INFO = "controltower:GetAccountInfo",
  ...
  GET_LANDING_ZONE_DRIFT_STATUS = "controltower:GetLandingZoneDriftStatus",
  GET_LANDING_ZONE_STATUS = "controltower:GetLandingZoneStatus",
  LIST_DIRECTORY_GROUPS = "controltower:ListDirectoryGroups",
  LIST_DRIFT_DETAILS = "controltower:ListDriftDetails",
  LIST_ENABLED_CONTROLS = "controltower:ListEnabledControls",
  LIST_ENABLED_GUARDRAILS = "controltower:ListEnabledGuardrails",
  LIST_EXTEND_GOVERNANCE_PRECHECK_DETAILS = "controltower:ListExtendGovernancePrecheckDetails",
  LIST_EXTERNAL_CONFIG_RULE_COMPLIANCE = "controltower:ListExternalConfigRuleCompliance",
  ...
  PERFORM_PRE_LAUNCH_CHECKS = "controltower:PerformPreLaunchChecks",
...
export enum NimbleStudio {
  ...
  START_STUDIO_S_S_O_CONFIGURATION_REPAIR = "nimble:StartStudioSSOConfigurationRepair",
...
export enum Personalize {
  ...
  CREATE_METRIC_ATTRIBUTION = "personalize:CreateMetricAttribution",
  ...
  DELETE_METRIC_ATTRIBUTION = "personalize:DeleteMetricAttribution",
  ...
  DESCRIBE_METRIC_ATTRIBUTION = "personalize:DescribeMetricAttribution",
  ...
  LIST_METRIC_ATTRIBUTION_METRICS = "personalize:ListMetricAttributionMetrics",
  LIST_METRIC_ATTRIBUTIONS = "personalize:ListMetricAttributions",
...
export enum Cloud9 {
  ...
  DESCRIBE_E_C2_REMOTE = "cloud9:DescribeEC2Remote",
  ...
  DESCRIBE_S_S_H_REMOTE = "cloud9:DescribeSSHRemote",
  ...
  MODIFY_TEMPORARY_CREDENTIALS_ON_ENVIRONMENT_E_C2 = "cloud9:ModifyTemporaryCredentialsOnEnvironmentEC2",
  ...
  UPDATE_S_S_H_REMOTE = "cloud9:UpdateSSHRemote",
...
export enum ElementalAppliancesandSoftware {
  ...
  CREATE_ORDER_V1 = "elemental-appliances-software:CreateOrderV1",
  ...
  GET_DELIVERY_ADDRESSES_V2 = "elemental-appliances-software:GetDeliveryAddressesV2",
  GET_ORDER = "elemental-appliances-software:GetOrder",
  GET_ORDERS_V2 = "elemental-appliances-software:GetOrdersV2",
  ...
  SUBMIT_ORDER_V1 = "elemental-appliances-software:SubmitOrderV1",
...
export enum Panorama {
  ...
  GET_WEB_SOCKET_U_R_L = "panorama:GetWebSocketURL",
  ...
  SIGNAL_APPLICATION_INSTANCE_NODE_INSTANCES = "panorama:SignalApplicationInstanceNodeInstances",
...
export enum Textract {
  ...
  ANALYZE_I_D = "textract:AnalyzeID",
...
export enum HealthLake {
  ...
  DESCRIBE_F_H_I_R_DATASTORE = "healthlake:DescribeFHIRDatastore",
  DESCRIBE_F_H_I_R_EXPORT_JOB = "healthlake:DescribeFHIRExportJob",
  DESCRIBE_F_H_I_R_IMPORT_JOB = "healthlake:DescribeFHIRImportJob",
  GET_CAPABILITIES = "healthlake:GetCapabilities",
  LIST_F_H_I_R_DATASTORES = "healthlake:ListFHIRDatastores",
  LIST_F_H_I_R_EXPORT_JOBS = "healthlake:ListFHIRExportJobs",
  LIST_F_H_I_R_IMPORT_JOBS = "healthlake:ListFHIRImportJobs",
  ...
  START_F_H_I_R_EXPORT_JOB = "healthlake:StartFHIRExportJob",
  START_F_H_I_R_IMPORT_JOB = "healthlake:StartFHIRImportJob",
...
export enum ServiceQuotas {
  ...
  GET_A_W_S_DEFAULT_SERVICE_QUOTA = "servicequotas:GetAWSDefaultServiceQuota",
  ...
  LIST_A_W_S_DEFAULT_SERVICE_QUOTAS = "servicequotas:ListAWSDefaultServiceQuotas",
...
export enum QLDB {
  ...
  DESCRIBE_JOURNAL_S3_EXPORT = "qldb:DescribeJournalS3Export",
  DESCRIBE_LEDGER = "qldb:DescribeLedger",
  EXECUTE_STATEMENT = "qldb:ExecuteStatement",
  EXPORT_JOURNAL_TO_S3 = "qldb:ExportJournalToS3",
  ...
  LIST_JOURNAL_S3_EXPORTS = "qldb:ListJournalS3Exports",
  LIST_JOURNAL_S3_EXPORTS_FOR_LEDGER = "qldb:ListJournalS3ExportsForLedger",
  LIST_LEDGERS = "qldb:ListLedgers",
  LIST_TAGS_FOR_RESOURCE = "qldb:ListTagsForResource",
  PARTI_Q_L_CREATE_INDEX = "qldb:PartiQLCreateIndex",
  PARTI_Q_L_CREATE_TABLE = "qldb:PartiQLCreateTable",
  PARTI_Q_L_DELETE = "qldb:PartiQLDelete",
  PARTI_Q_L_DROP_INDEX = "qldb:PartiQLDropIndex",
  PARTI_Q_L_DROP_TABLE = "qldb:PartiQLDropTable",
  PARTI_Q_L_HISTORY_FUNCTION = "qldb:PartiQLHistoryFunction",
  PARTI_Q_L_INSERT = "qldb:PartiQLInsert",
  PARTI_Q_L_REDACT = "qldb:PartiQLRedact",
  PARTI_Q_L_SELECT = "qldb:PartiQLSelect",
  PARTI_Q_L_UNDROP_TABLE = "qldb:PartiQLUndropTable",
  PARTI_Q_L_UPDATE = "qldb:PartiQLUpdate",
...
export enum DirectConnect {
  ...
  CREATE_B_G_P_PEER = "directconnect:CreateBGPPeer",
  ...
  DELETE_B_G_P_PEER = "directconnect:DeleteBGPPeer",
...
export enum Neptune {
  ...
  CANCEL_M_L_DATA_PROCESSING_JOB = "neptune-db:CancelMLDataProcessingJob",
  CANCEL_M_L_MODEL_TRAINING_JOB = "neptune-db:CancelMLModelTrainingJob",
  CANCEL_M_L_MODEL_TRANSFORM_JOB = "neptune-db:CancelMLModelTransformJob",
  CANCEL_QUERY = "neptune-db:CancelQuery",
  CREATE_M_L_ENDPOINT = "neptune-db:CreateMLEndpoint",
  DELETE_DATA_VIA_QUERY = "neptune-db:DeleteDataViaQuery",
  DELETE_M_L_ENDPOINT = "neptune-db:DeleteMLEndpoint",
  ...
  GET_M_L_DATA_PROCESSING_JOB_STATUS = "neptune-db:GetMLDataProcessingJobStatus",
  GET_M_L_ENDPOINT_STATUS = "neptune-db:GetMLEndpointStatus",
  GET_M_L_MODEL_TRAINING_JOB_STATUS = "neptune-db:GetMLModelTrainingJobStatus",
  GET_M_L_MODEL_TRANSFORM_JOB_STATUS = "neptune-db:GetMLModelTransformJobStatus",
  ...
  LIST_M_L_DATA_PROCESSING_JOBS = "neptune-db:ListMLDataProcessingJobs",
  LIST_M_L_ENDPOINTS = "neptune-db:ListMLEndpoints",
  LIST_M_L_MODEL_TRAINING_JOBS = "neptune-db:ListMLModelTrainingJobs",
  LIST_M_L_MODEL_TRANSFORM_JOBS = "neptune-db:ListMLModelTransformJobs",
  ...
  START_M_L_DATA_PROCESSING_JOB = "neptune-db:StartMLDataProcessingJob",
...
export enum DataSync {
  ...
  CREATE_LOCATION_S3 = "datasync:CreateLocationS3",
  ...
  DESCRIBE_LOCATION_S3 = "datasync:DescribeLocationS3",
...
export enum Organizations {
  ...
  DELETE_RESOURCE_POLICY = "organizations:DeleteResourcePolicy",
  ...
  DESCRIBE_RESOURCE_POLICY = "organizations:DescribeResourcePolicy",
  DETACH_POLICY = "organizations:DetachPolicy",
  DISABLE_A_W_S_SERVICE_ACCESS = "organizations:DisableAWSServiceAccess",
  DISABLE_POLICY_TYPE = "organizations:DisablePolicyType",
  ENABLE_A_W_S_SERVICE_ACCESS = "organizations:EnableAWSServiceAccess",
  ...
  LIST_A_W_S_SERVICE_ACCESS_FOR_ORGANIZATION = "organizations:ListAWSServiceAccessForOrganization",
  ...
  PUT_RESOURCE_POLICY = "organizations:PutResourcePolicy",
...
export enum AccountManagement {
  ...
  GET_REGION_OPT_STATUS = "account:GetRegionOptStatus",
